        ...
        <div className="py-8 px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-8 mt-8">
                <div className="lg:w-1/2">
                    ...
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Xem chi tiết</button>
                </div>
